...
# parent(10)
f_c = parent(10) # assertion is tru

print("*************")
print("Returning function name FC : ", f_c) # reference of
...
print(x)
print("Printing parent1 function : ", parent1) # reference of parent
f_chil = parent1()
print(f_chil)
