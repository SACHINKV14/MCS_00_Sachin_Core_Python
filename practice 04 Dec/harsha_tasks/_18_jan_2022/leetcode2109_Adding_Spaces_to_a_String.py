...
original string where spaces will be added. Each space should be inserted before the character at the
given index.
...
class Solution:
    def addSpaces(self, s: str, spaces) -> str:
        ...
        j=0
        for i in spaces:
            i=i+j     #after adding space index changes
