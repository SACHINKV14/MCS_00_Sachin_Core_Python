...
a = [1,2,3,4]
print(a[::-1])  # 4 3 2 1
result = [x * x for x in range(10)]   #  [ 0, 1
print(type(result))
a = []
for x in range(10):
    a.append(x)
...
val=sum(x*x for x in range(1,3))  # 1 *1, 2*2
print(val)
...
print('................new iteration',next(f))         #the generator starts in an idle state initially
print('................new iteration',next(f))         #the generator starts in an idle state initially
print('................new iteration',next(f))         #the generator starts in an idle state initially
a = []
for i in range(10):
