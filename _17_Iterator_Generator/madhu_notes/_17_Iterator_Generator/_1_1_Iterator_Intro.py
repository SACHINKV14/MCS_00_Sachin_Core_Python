...
#for loop will convert list to an iterator it will execute next elements
# iter next
li = []       # list([])
print("Empty list : ", li)
...
try:
    print(my_iter.__next__()) #4 # 3. Iterate through it using __next()__
...
# Here, we show an example that will give us next power of 2 in each iteration. Power exponent starts from zero
